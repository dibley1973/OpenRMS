//-----------------------------------------------------------------------
// <copyright file="AlwaysFalseStateChangeRuleSet.cs" company="Chesil Media">
...
namespace ORMS.Contexts.ItemManagement.Domain.UnitTests.Tests.Fakes.IStateChangeRuleSet
{
    ...
    /// <summary>
    /// A fake state change rule set that always returns <c>false</c>.
    /// </summary>
    /// <seealso cref="IStateChangeRuleSet{ItemState}" />
    public class AlwaysFalseStateChangeRuleSet : IStateChangeRuleSet<ItemState>
    {
        /// <summary>
        ...
        /// <returns>
        /// Always returns <c>false</c> regardless of states provided.
        /// </returns>
